  ...
  themes: {
    light: {
      ...
      componentsStyles: {
        ...
        button: "flex justify-center items-center gap-2 p-2 text-gray-700 font-bold bg-gray-100 rounded-md border transition-colors cursor-pointer border-gray-300 hover:bg-gray-200",
        buttonSmall: "text-xs flex justify-center items-center gap-2 py-1 px-2 text-gray-700 font-semibold bg-gray-100 rounded-md border transition-colors cursor-pointer border-gray-300 hover:bg-gray-200",

        dropdown: "bg-white border border-gray-300 rounded-md shadow-lg z-50 min-w-full max-h-60 overflow-y-auto",
        dropdownItem: "w-full text-left px-3 py-2 hover:bg-stone-100 transition-colors whitespace-nowrap",
        dropdownItemActive: "border-l-2 text-stone-700 bg-stone-200 font-bold",

        navigationRowBase: "flex items-center gap-2 cursor-pointer px-2 py-1 focus:outline-none",
        navigationRowActive: "text-stone-700 font-semibold bg-stone-200 border-l-2 border-stone-500",
        ...
        keyHints: "text-xs text-gray-500 border border-gray-300 rounded bg-white px-1.5 py-0.5 pointer-events-none",
        codeHeader: "flex items-center justify-between px-3 py-1.5 bg-stone-700/80 text-white border-b",
      ...
      sectionStyles: {
        ...
        headerMobileBackground: "bg-white border-b border-gray-200 z-40 p-4 md:hidden shadow-md space-y-4",
    ...
    dark: {
      ...
      componentsStyles: {
        ...
        button: "flex justify-center items-center gap-2 p-2 text-gray-100 font-bold bg-slate-800 rounded-md border transition-colors cursor-pointer border-gray-600 hover:bg-slate-700/70",
        buttonSmall: "text-xs flex justify-center items-center gap-2 py-1 px-2 text-gray-100 font-semibold bg-slate-800 rounded-md border transition-colors cursor-pointer border-gray-600 hover:bg-slate-700/70",

        dropdown: "bg-slate-800 border border-gray-600 rounded-md shadow-lg z-50 min-w-full max-h-60 overflow-y-auto",
        dropdownItem: "text-white w-full text-left px-3 py-2 hover:bg-slate-600/30 transition-colors whitespace-nowrap",
        dropdownItemActive: "border-l-2 bg-lime-900/60 font-bold",

        navigationRowBase: "text-gray-50 flex items-center gap-2 cursor-pointer px-2 py-1 focus:outline-none",
        navigationRowActive: "text-gray-50 font-semibold bg-lime-900/60 border-l-2 border-blue-50",
        ...
        keyHints: "text-xs text-gray-400 border border-gray-600 rounded px-1.5 py-0.5 pointer-events-none",
        codeHeader: "flex items-center justify-between px-3 py-1.5 bg-lime-900/80 text-white border-b",
      ...
      sectionStyles: {
        ...
        headerMobileBackground: "bg-zinc-900 border-b border-gray-200 z-40 p-4 md:hidden shadow-md space-y-4",
