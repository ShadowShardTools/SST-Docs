...
export const Config = {
  ...
  MARGIN: 35,
  ENABLE_SPLIT_BY_CATEGORY: true,
  ENABLE_SPLIT_NESTED_CATEGORIES: true,
  ENABLE_SPLIT_BY_DOCUMENT: true,
  ENABLE_PAGE_NUMBERS: true,
  DISABLE_TOC_PAGE_NUMBER: true,
  ...
  COLORS: {
    ...
    documentHeaderBackground: rgb(0xe7 / 255, 0xe5 / 255, 0xe4 / 255),
    documentHeaderBorder: rgb(0xa8 / 255, 0xa2 / 255, 0x9e / 255),
    documentHeaderText: rgb(0x57 / 255, 0x53 / 255, 0x4e / 255),
    documentHeaderSubtext: rgb(0x78 / 255, 0x71 / 255, 0x6c / 255),
