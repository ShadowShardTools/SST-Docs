  ...
  themes: {
    light: {
      textStyles: {
        ...
        searchModalItemFoundSectionText: "text-xs text-gray-500 mt-1 line-clamp-2",
      ...
      componentsStyles: {
        ...
        button: "font-bold text-gray-700 bg-gray-100 border border-gray-300 rounded-md transition-colors hover:bg-gray-200",
        buttonSmall: "text-xs font-semibold text-gray-700 bg-gray-100 border border-gray-300 rounded-md transition-colors hover:bg-gray-200",

        dropdown: "bg-white border border-gray-300 rounded-md shadow-lg",
        dropdownItem: "text-left hover:bg-stone-200/50 transition-colors whitespace-nowrap",
        dropdownItemActive: "border-l-2 text-stone-700 bg-stone-200 font-bold",

        navigationRowBase: "focus:outline-none",
        navigationRowActive: "font-semibold text-stone-700 bg-stone-200 border-l-2 border-stone-500 transition-colors",
        navigationRowFocused: "ring-2 ring-stone-500",
        navigationRowHover: "hover:text-stone-500 transition-colors",

        keyHints: "text-xs text-gray-500 border border-gray-300 rounded bg-white",
      ...
      sectionStyles: {
        ...
        headerMobileBackground: "bg-white border-b border-gray-200 shadow-md",
    ...
    dark: {
      textStyles: {
        ...
        searchModalItemFoundSectionText: "text-xs text-gray-300 mt-1 line-clamp-2",
      ...
      componentsStyles: {
        ...
        button: "font-bold text-gray-100 bg-indigo-900/50 border border-indigo-800 rounded-md transition-colors hover:bg-indigo-700/70",
        buttonSmall: "text-xs font-semibold text-gray-100 bg-indigo-800 border border-indigo-600 rounded-md transition-colors hover:bg-indigo-700/70",

        dropdown: "bg-slate-800 border border-indigo-600 rounded-md shadow-lg",
        dropdownItem: "text-white text-left hover:bg-indigo-600/50 transition-colors whitespace-nowrap",
        dropdownItemActive: "border-l-2 bg-indigo-900/60 font-bold",

        navigationRowBase: "text-gray-50 focus:outline-none",
        navigationRowActive: "font-semibold text-gray-50 bg-indigo-900/60 border-l-2 border-blue-50 transition-colors",
